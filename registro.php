...
<form action="validar/registro.php" method="post">
	...
	<div class="row">
		...
		<div class="col-10">
			...
			<div class="input"><input type="number_format" name="telefono" class="form-control" placeholder="Digite Su Telefono" required=""></div>
  			<div class="input"><input type="text" name="direccion" class="form-control" placeholder="Digite Su Dirección" required=""></div>

			</div>
  			


  			<div class="button"><button type="submit" class="btn btn-danger">REGISTRARME</button></div><br>
  			<p>¿Ya tienes una cuenta? <a href="sesion.php"><font color="white">Logeate</font></a></p>
