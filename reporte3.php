...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    $this->Cell(30,10,'LISTA DE STOCK','C');
    // Salto de línea
    $this->Ln(20);
	...
	$this->Cell(30,10,'STOCK DISPONIBLE',1,1,'C',0);
}
...
$consulta="SELECT idp,codpro, nombre,precio,stock FROM producto ORDER BY stock";
